...
The user's `email` and `password` should be passed in a header `Authorization` with the format `Basic [Base64 of email:password]`. Example:

```bash
Basic Ym9iQGR5bGFuLmNvbTp0b3RvMTIzNCE=
```

where `Ym9iQGR5bGFuLmNvbTp0b3RvMTIzNCE=` is the base64 of `bob@dylan.com:toto1234!`
